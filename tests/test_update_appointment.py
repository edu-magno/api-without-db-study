...
def test_update_appointment(clean_up_fixture):
...
def test_update_appointment_if_date_not_available(clean_up_fixture):

    make_appointments(file_path, fieldnames, appointment1)
    make_appointments(file_path, fieldnames, appointment2)

    result = update_appointment(file_path, fieldnames, '2', {
                                'date': 'Tue Sep 09 2020 10:52:13 GMT-0300 (-03)'})
    expected = {
